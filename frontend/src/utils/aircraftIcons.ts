...
const ICON_PATH_MAP: Record<AircraftCategory, string> = {
  ...
  A2: '/src/assets/icons/aircraft-a2-small.svg',
  A3: '/src/assets/icons/aircraft-a3-large.svg',
  A4: '/src/assets/icons/aircraft-a4-highvortex.svg',
  A5: '/src/assets/icons/aircraft-a5-heavy.svg',
  A6: '/src/assets/icons/aircraft-a6-highperf.svg',
  A7: '/src/assets/icons/aircraft-a7-rotorcraft.svg',
  B1: '/src/assets/icons/aircraft-b1-glider.svg',
  B2: '/src/assets/icons/aircraft-b2-balloon.svg',
  B3: '/src/assets/icons/aircraft-b3-uav.svg',
  B4: '/src/assets/icons/aircraft-b4-smalluav.svg',
  B5: '/src/assets/icons/aircraft-b5-space.svg',
  B6: '/src/assets/icons/aircraft-b6-ultralight.svg',
  default: '/src/assets/icons/aircraft-default.svg'
};
